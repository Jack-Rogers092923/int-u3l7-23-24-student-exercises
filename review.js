...
let optionOneButton = document.querySelector(".option-one"); // This selects the button with class "option-one"
let optionOneScreen = document.querySelector(".option-one-screen"); // This selects the div with class "option-one-screen"
// CODE SOLO, PART 1
...
let optionTwoButton = document.querySelector(".option-two"); // This selects the button with class "option-two"
let optionTwoScreen = document.querySelector(".option-two-screen"); // This selects the div with class "option-two-screen"
